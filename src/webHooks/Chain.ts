...
abstract class AbstractHandler<Request = WebTriggerEvent, Body = GitHook, Result = WebTriggerResponse>
    implements Handler<Request, Body, Result> {
...
export class CheckActionHandler extends AbstractHandler {
